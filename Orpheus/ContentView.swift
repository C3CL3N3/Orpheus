...
struct ContentView: View {
    ...
    private var textForeground: Color {
        Color(settings.textColor(artworkAccent: player.artworkAccentColor))
    }

    private var secondaryForeground: Color {
        Color(settings.textColor(artworkAccent: player.artworkAccentColor).withAlphaComponent(0.65))
    }
